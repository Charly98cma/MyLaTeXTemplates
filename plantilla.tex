...
\begin{titlepage}
  ...
  \begin{figure}[H] % H -> emplaza las imagenes en el mismo lugar en el que se encuentran en el codigo
    \centering
    \subfloat{{\includegraphics[width=7cm]{LogoUPM}}}
    \qquad
    \subfloat{{\includegraphics[width=2.75cm]{LogoFI}}}\\[0.5cm]
  \end{figure}
...
\pagenumbering{arabic} % Numeracion de páginas a partir de este punto.
